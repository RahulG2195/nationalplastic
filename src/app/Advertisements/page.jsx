            ...
            <div class="inn-content-wrap">
              ...
              <div class="investor-table">
                <table className='table table-rsponsive table-striped'>
                  <thead>
                    <tr>
                      <th className='col'>FY 2023-24 - Q1</th>
                      <th className='col'>FY 2023-24 - Q2</th>
                      <th className='col'>FY 2023-24 - Q3</th>
                      <th className='col'>FY 2023-24 - Q4</th>
                    </tr>
                    <tr>
              ...
              <div class="investor-table">
                <table className='table table-rsponsive table-striped'>
                  <thead>
                    <tr>
                      <th className='col'>FY 2022-23 - Q1</th>
                      <th className='col'>FY 2022-23 - Q2</th>
                      <th className='col'>FY 2022-23 - Q3</th>
                      <th className='col'>FY 2022-23 - Q4</th>
                    </tr>
                    <tr>
                      <td data-title="Quarter - 1">
                        <ul>
              ...
              <div class="investor-table">
                <table className='table table-rsponsive table-striped'>
                  <thead>
                    <tr>
                      <th className='col'>FY 2021-22 - Q1</th>
                      <th className='col'>FY 2021-22 - Q2</th>
                      <th className='col'>FY 2021-22 - Q3</th>
                      <th className='col'>FY 2021-22 - Q4</th>
                    </tr>
                    <tr>
                      <td data-title="Quarter - 1">
                        <ul>
