              ...
              <div className="inn-content-wrap">
                ...
                <div className="investor-table">
                  <table className='table table-responsive table-striped table-light table-bordered'>
                    <tbody>
                      <tr>
                        <td><a href="/Assets/pdf/outcome-of-meeting-7-feb-2019.pdf" target="_blank"><i className="fa fa-file-pdf-o" aria-hidden="true"></i> Outcome of Board Meeting - 07 February 2019</a></td>
                      </tr>
                      <tr>
                        <td><a href="/Assets/pdf/Outcome-of-Board-Meeting_30_Nov_2018.pdf" target="_blank"><i className="fa fa-file-pdf-o" aria-hidden="true"></i> Outcome of Board Meeting - 13 November 2018</a></td>
                      </tr>
                      <tr>
                        <td><a href="/Assets/pdf/Outcome-of-Board-Meeting-29.05.2018.pdf" target="_blank"><i className="fa fa-file-pdf-o" aria-hidden="true"></i> Outcome of Board Meeting - 29 May 2018</a></td>
                      </tr>
                      <tr>
                        <td><a href="/Assets/pdf/Outcome-of-the-BM-03-aug-18.pdf" target="_blank"><i className="fa fa-file-pdf-o" aria-hidden="true"></i> Outcome of Board Meeting - 03 August 2018</a></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
