              ...
              <div className="inn-content-wrap">
                ...
                <div className="investor-table">
                  <table className='table table-responsive table-striped table-light'>
                    <tbody>
                      ...
                      <tr>
                        <td><a href="/Assets/pdf/AGM_Disclosure_of_Voting_Results_Reg-44_2015-16.pdf" target="_blank"><i className="fa fa-file-pdf-o" aria-hidden="true"></i>  Disclosure of Voting Results - Reg 44</a></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div className="investor-table">
                  <table className='table table-responsive table-striped table-light'>
                    <tbody>
                      <tr>
                        <td><a href="/Assets/pdf/AGM_Disclosure_of_Voting_Results_Clause-35A_2014-15.pdf" target="_blank"><i className="fa fa-file-pdf-o" aria-hidden="true"></i>  Disclosure of Voting Results - Clause 35A</a></td>
                      </tr>
                      <tr>
