        ...
        <div className="row pt-5 gap-5 justify-content-center">
          <div className="col-12 col-md-8 order-2 order-md-1 order-lg-1 company-profile-content mob_content">
            <div className="mb-4">
              ...
              <div className='spacing' style={{textAlign: 'justify'}} dangerouslySetInnerHTML={{ __html: content.history || '' }} />
            </div>
            <div className="mb-4">
              <h2 className="company-profile-title">Our Brand</h2>
              <div className='spacing' style={{textAlign: 'justify'}} dangerouslySetInnerHTML={{ __html: content.brand || '' }} />
            </div>
          </div>
