                    ...
                    <div className="container text-center mt-5 d-flex justify-content-center">
                        <div className="row">
                            {categories.map((category) => (
                                <div key={category.category_id} className="col-lg-2 col-sm-6 col-xs-12 col-md-4 my-4">
                                    <TopPicsCard imgSrc={`/Assets/images/circular/${category.image_name}`} imgtext={category.category_name} />
                                </div>
                            ))}
                        </div>
                    </div>
