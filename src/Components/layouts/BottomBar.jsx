  ...
  return (
    <div className="row px-4 d-inline-flex align-items-center bottom_nav position-relative mainrow">
      <div className="col first ">
        <p> <Link className="nav-link" href="/ProductCatlogue">Premium Event Chair</Link></p>
      ...
      <p> <Link className="nav-link" href="/ProductCatlogue">Without Arm Tent</Link></p>
      ...
      <div className="col second ">
        <p> <Link className="nav-link" href="/ProductCatlogue">Popular Chair</Link></p>
        <div className='ulCont SecondDrop mx-4 p-3'>
          ...
          <div className='d-flex gap-5'>
            <div className='d-flex gap-5 scroll'>
              ...
              <div>
              <p><Link className="nav-link" href="/ProductDetail">GETZ/ BEST/ZEST</Link></p> 
              </div> 
      ...
      <div className="col second ">
      <p> <Link className="nav-link" href="/ProductCatlogue">Cabinet</Link></p>
        <div className='ulCont SecondDrop mx-4 p-3'>
      ...
      <div className="col second ">
      <p> <Link className="nav-link" href="/ProductCatlogue">Baby Chair</Link></p>
        <div className='ulCont SecondDrop mx-4 p-3'>
      ...
      <div className="col second ">
      <p> <Link className="nav-link" href="/ProductCatlogue">Stool</Link></p>
        <div className='ulCont SecondDrop mx-4 p-3'>
      ...
      <div className="col second ">
      <p> <Link className="nav-link" href="/ProductCatlogue">Table</Link></p>
        <div className='ulCont SecondDrop mx-4 p-3'>
      ...
      <div className="col second ">
      <p> <Link className="nav-link" href="/ProductCatlogue">Box</Link></p>
        <div className='ulCont SecondDrop mx-4 p-3'>
      ...
      <div className="col second ">
  <p> <Link className="nav-link" href="/ProductCatlogue">Drawer</Link></p>
  <div className='ulCont SecondDrop mx-4 p-3'>
