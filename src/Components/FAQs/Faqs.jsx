        ...
        <>
            ...
            <div className="mt-5 ">
                <div className="text-center">
                    <div className="fs-1 fw-bold darkBlue">FAQ'<span className="text-danger">S</span> </div>
                </div>
            </div>
                ...
                {faqData.map((faq, index) => (
                    <div key={index} className='mt-2'>
                        <Accordion className='py-4'>
                            <AccordionSummary
                                expandIcon={<div className='border border-2 border-black rounded-circle text-black fw-bold'>
                                    <AddIcon /></div>}
