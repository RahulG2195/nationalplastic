      ...
      <div className="company-profile-content">
        <div className="container mb-2">
          ...
          <p className="company-profile-text">
            ...
            manufacturer of houseware products but also the largest exporter of
            plastic furniture in India.
          </p>
          <p className="company-profile-text">
            National Plastic Industries Ltd., then took a quantum leap and
            commenced the commercial production of Molded Furniture in 1994 and
            since then has gone from strength to strength. Today National Molded
            Furniture is available throughout India and has been widely accepted
            by both traders as well as consumers. National has a varied range of
            products that can suit all applications and different kinds of
            budgets. Consumers prefer National Molded Furniture for its quality,
            color and finishing.
          </p>
        </div>
        ...
        <div className="container mb-2">
          ...
          <p className="company-profile-text">
            ...
            and "NATIONAL" products are available across 36 countries including
            America, Australia etc. "National Plastics Industries Ltd." with its
            constant Endeavour for innovation will continue to introduce many
            new and innovative products both for domestic as well as
            International markets and thereby will fulfill its commitment to the
            society as a whole by offering premium quality products at the most
            affordable prices.
          </p>
